...
<body class="antialiased bg-slate-900 text-slate-100 selection:bg-cyan-500 selection:text-white min-h-screen relative overflow-x-hidden">
    
    <!-- Liquid Glass Ambient Background -->
    <div class="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <!-- Vibrant fluid blobs -->
        <div class="absolute -top-1/4 -right-1/4 w-[800px] h-[800px] bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full mix-blend-screen filter blur-[120px] opacity-40 animate-blob"></div>
        <div class="absolute top-1/4 -left-1/4 w-[600px] h-[600px] bg-gradient-to-tr from-fuchsia-500 to-purple-600 rounded-full mix-blend-screen filter blur-[100px] opacity-40 animate-blob animation-delay-2000"></div>
        <div class="absolute -bottom-1/4 left-1/3 w-[700px] h-[700px] bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full mix-blend-screen filter blur-[140px] opacity-30 animate-blob animation-delay-4000"></div>
        
        <!-- Noise Overlay for texture -->
        <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20 mix-blend-overlay"></div>
    </div>
